...
def main(argv=None):
    ...
    ac=sub.add_parser("accelerate"); ac.add_argument("changed_paths",nargs="+"); ac.add_argument("--max-parallel",type=int,default=None)
    ...
    if args.cmd=="accelerate":
        r=e.acceleration_plan(args.changed_paths,args.max_parallel); print(json.dumps(r,indent=2)); return 0
